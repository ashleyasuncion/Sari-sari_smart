...
;(function() {
  ...
  const strings = {
    en: {
      ...
      todayEarningsInput: 'Today"s Sales',
      todayEarningsHint: 'Total cash from sales today',
    ...
    tutHelp: 'Help Tutorial',
      ...
      homeTutorial2: 'Today\'s Sales shows your total cash sales and profit (credit/utang sales excluded). Tap it to go to the Sales page.',
      ...
      salesTutorial3: "Enter your Today's Sales (Benta) — the total cash you received from customers today. This is your total revenue, NOT your profit (tubo). Profit is calculated automatically: Sales (Benta) minus Gastos sa Paninda equals Tubo (Gross Profit).",
    ...
    fil: {
      ...
      todayEarningsInput: 'Benta Ngayon',
      todayEarningsHint: 'Kabuuang benta ngayon',
      grossProfit: 'Gross Profit',
    ...
    saleLabel: 'Benta',
      ...
      recordingSaleContent: 'Pumunta sa Benta at i-tap ang "I-record ang Benta Ngayon". Ilagay ang gastos sa paninda at ang benta ngayong araw. Awtomatikong magpapakita ng kita at pambili ng paninda.',
      ...
      viewingReportsContent: 'Ang iyong daily summary ay makikita sa Home screen. Benta, stock alert, utang, at tips sa negosyo — lahat sa isang lugar.',
      // Settings
      ...
      tutorial6: 'Ang Home screen ay nagbibigay sa iyo ng kumpletong snapshot ng iyong tindahan: benta ngayon (cash lang), stock alert, natitirang utang, at End-of-Day closing routine. Ang mga business tips ay makakatulong sa iyong gumawa ng mas matalinong desisyon.',
    ...
    tutHelp: 'Help na Tutorial',
      ...
      homeTutorial2: 'Ang Benta Ngayon ay nagpapakita ng iyong kabuuang benta at kita. I-tap ito para pumunta sa Sales page.',
      ...
      salesTutorial3: 'Ilagay ang iyong Benta Ngayon — ang kabuuang cash na natanggap mo mula sa mga kostumer ngayong araw. Hindi ito ang tubo (profit). Ang tubo ay awtomatikong kinukwenta: Benta minus Gastos sa Paninda equals Tubo (Gross Profit).',
